...
process DOWNLOAD {
    ...
    script:
    """
    datasets download genome accession GCF_000005845.2 --filename E-Coli_dataset.zip
    unzip -o E-Coli_dataset.zip
    cp ncbi_dataset/data/GCF_000005845.2/GCF_000005845.2_ASM584v2_genomic.fna .
    gzip GCF_000005845.2_ASM584v2_genomic.fna
    """
}
